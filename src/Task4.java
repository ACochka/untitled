...
public class Task4 {
    public static void main(String[] args) {
        sochinenie("hello my name is Bessie and this is my essay",10,7);
...
//
    ...
    public static void sochinenie(String str,int n,int k){
        ...
        while (true){
            ...
            if(str.length()<k){//Если строка меньше чем ограничение для проверок с k, то вывожу
